...
<link href="css/itemslider.css" type="text/css" rel="stylesheet" media="screen" /> <!-- list_work -->
...
<script type="text/javascript" src="js/modernizr.custom.63321.js"></script><!--itemslider-modernizr-->
...
<script type="text/javascript" src="js/jquery.catslider.js"></script><!--itemslider-->
        ...
        <div id="container">
            ...
            <div class="content-wrap">
                <div id="featured">
					...
					<ul>
						<li><a href="#"><img src="images/laptopre/hp-10.jpg" alt="img01"><h4>HP<br><small>6.900.000 VND</small></h4></a><span class="sale">Sale</span></li>
						<li><a href="#"><img src="images/laptopre/thinkpad-2.jpg" alt="img02"><h4>ThinkPad X1<br><small>6.500.000 VND</small></h4></a></h4></a></li>
						<li><a href="#"><img src="images/laptopre/thinkpad-1.jpg" alt="img03"><h4>ThinkPad X2<br><small>7.000.000 VND</small></h4></a></h4></a></li>
						<li><a href="#"><img src="images/laptopre/asus-1.jpg" alt="img04"><h4>Asus<br><small>99.000.000 VND</small></h4></a></h4></a></li>
					</ul>
					<ul>
						<li><a href="#"><img src="images/products/dell-1.jpg" alt="img05"><h4>Dell Vostro 3251<br><small>$249.00</small></h4></a></h4></a></li>
						<li><a href="#"><img src="images/products/dell-4.jpg" alt="img08"><h4>Dell Inspiron 660<br><small>$449.00</small></h4></a></h4></a><span class="new">New</span></li>
                        <li><a href="#"><img src="images/products/dell-3.jpg" alt="img05"><h4>Dell Vostro E5440<br><small>$430.00</small></h4></a></h4></a></li>

					</ul>
					<ul>
						<li><a href="#"><img src="images/products/hp-1.jpg" alt="img09"><h4>HP Probook 440s<br><small>$49.00</small></h4></a></h4></a><span class="new">New</span></li>
						<li><a href="#"><img src="images/products/hp-2.jpg" alt="img10"><h4>HP Galaxy<br><small>$49.00</small></h4></a></h4></a></li>
						<li><a href="#"><img src="images/products/hp-3.jpg" alt="img11"><h4>HP Sysnitor<br><small>$49.00</small></h4></a></h4></a></li>
					</ul>
					<ul>
						<li><a href="#"><img src="images/products/dell-1.jpg" alt="img12"><h4>Aspries<br><small>$49.00</small></h4></a></h4></a><span class="sale">Sale</span></li>
						<li><a href="#"><img src="images/products/dell-2.jpg" alt="img13"><h4>Travel Mate<br><small>$49.00</small></h4></a></h4></a></li>
						<li><a href="#"><img src="images/products/dell-3.jpg" alt="img14"><h4>Desire 440<br><small>$49.00</small></h4></a></h4></a><span class="sale">Sale</span></li>
						<li><a href="#"><img src="images/products/dell-4.jpg" alt="img15"><h4>Satelite<br><small>$49.00</small></h4></a></h4></a></li>
					</ul>
					<nav class="selectmenu">
						<a href="#"> General Laptop</a>
						<a href="#">Dell</a>
						<a href="#">HP</a>
						<a href="#">Acer</a>
					</nav>
                        ...
                        <ul id="mycarousel" class="jcarousel-skin-tango item da-thumbs">
                            <li style="border: solid lightgray 1px;">
                                ...
                                <article class="da-animate da-slideFromRight" style="display: block;">
                                    ...
                                    <a href="images/preview/work_1_l.jpg" rel="prettyPhoto[gallery1]" class="zoom tip" title="Zoom In" ></a></p>
                                </article>
                            </li>
                            <li style="border: solid lightgray 1px;">
