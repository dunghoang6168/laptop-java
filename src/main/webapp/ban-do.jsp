        	...
        	<nav>  
                ...
                <div >
                    <section>
                        ...
                        <h2>STORE ADDRESS</h2>
                        <p>
                        <h4>Trung Tâm Đào Tạo Lập Trình Viên Quốc Tế Softech Aptech<br>

                        Address: 38 Yên Bái, Hải Châu, Q. Hải Châu, Đà Nẵng, Vietnam<br>
                        Phone:   +84 511 3584 919<br>

                        Email :  info@laptopre.com<br>

                        Website :laptopre<br></h4>
                        </p>
                            <section class="content">
                                <body onLoad="initialize()">
                                    <div id="div_id" style="height:500px; width:850px"></div>
                                </body>
                            </section>
                        
                        <div style="padding: 40px; padding-top: 600px;">
                        ...
                        <p>Việt Nam<br><br>
                              Tel: 012345678910<br>
                              Fax: 012345678910<br>
                              Email: <a href="mailto:info@laptopre.com">info@laptopre.comli.com</a></p>
