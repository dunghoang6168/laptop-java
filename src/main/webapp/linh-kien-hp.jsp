...
<script type="text/javascript" src="js/productview.js"></script><!--productgridlistview-->
                ...
                <div>
                    ...
                    <label>
                        <select>
                            ...
                            <option selected>Vietnam Đồng- VND</option>
                        </select>
                    </label>​
                    </p>
                </div>
            ...
            <div id="top2">
                ...
                <a href="#" class="close"><img src="images/process-stop.png" class="btn_close" title="Close Window" alt="Close" /></a>
                  <form method="post" class="signin" action="#">
                        ...
                        <p>
                        <a class="forgot" href="#">Quên mật khẩu?</a> / <a class="register" href="dangky.jsp">Tạo Tài Khoản</a>
                        </p>        
                        </fieldset>
                  </form>
                </div>
        ...
        <div id="container">
            <nav>  
                <ul id="mega-menu-3" class="mega-menu">
                    <li class="first"><a href="index.jsp" class="current">Trang Chủ</a></li>
                    <li><a href="laptop-re.jsp">Laptop Rẻ</a>
                        <ul>
                            <li><a href="laptop-1.jsp">Laptop cũ đời Mới</a>
                ...
                <li><a href="linh-kien.jsp">Linh kiện</a>
                    <ul>
                        ...
                        <li><a href="linh-kien-chuot.jsp">Chuột</a></li>
                        ...
                        <ul id="products" class="list clearfix">
                        	<li class="da-thumbs item">
                            	<div class="product-thumb-hover">
                                    <section class="left">
                                        <img src="images/products/dell-3.jpg" alt="">
                                        <p class="sale">Sale</p>
                                        <article class="da-animate da-slideFromRight" style="display: block;">
                                            <h3>Dell Inspiron 15</h3>
                                            <p>
                                            <a href="product-detail.jsp" class="link tip" title="View Detail"></a>&nbsp;
                                            <a href="cart.jsp" class="cart tip" title="Add to cart"></a>&nbsp;&nbsp;
                                ...
                                <section class="center">
                                	<h3>Dell Inspiron 15</h3>
                                    <em>Category: <a href="laptop-cu-doi-moi">Laptop Cũ Đời Mới</a></em>
                                </section>
                                <section class="right">
                                    <span class="price"><small>$320.00</small>&nbsp;&nbsp; $95.00</span>
                                    <ul class="menu-button">
                                        <li><a href="cart.jsp" class="cart tip" title="Add to Cart"></a></li>
                                        <li><a href="images/preview/work_1_l.jpg" rel="prettyPhoto[gallery1]" class="zoom tip" title="Zoom"></a></li>
                                        <li><a href="wishlist.jsp" class="wishlist tip" title="Add to Wishlist"></a></li>
                                        <li><a href="compare.jsp" class="compare tip" title="Compare"></a></li>
                                        <li><a href="product-detail.jsp" class="link tip" title="View Detail"></a></li>
                                    </ul>
                                </section>
                            </li>
                            <li class="da-thumbs item">
                                ...
                                <section class="center">
                                	<h3>Dell Vostro 3650</h3>
                                    <em>Category: <a href="laptop-cu.jsp">Laptop Cũ Đời Mới</a></em>
                                </section>
                                <section class="right">
                            ...
                            <li class="da-thumbs item">
                                ...
                                <section class="center">
                                	<h3>Dell XPS 15</h3>
                                    <em>Category: <a href="#">Laptop Cũ Đời Mới</a></em>
                                </section>
                                <section class="right">
                            ...
                            <li class="da-thumbs item">
                            	<div class="product-thumb-hover">
                                    <section class="left">
                                        <img src="images/products/dell-4.jpg" alt="">
                                        <article class="da-animate da-slideFromRight" style="display: block;">
                                            <h3>Dell Vostro E5440</h3>
                                            <p>
                                            <a href="product-detail.jsp" class="link tip" title="View Detail"></a>&nbsp;
                                            <a href="cart.jsp" class="cart tip" title="Add to cart"></a>&nbsp;&nbsp;
                                ...
                                <section class="center">
                                	<h3>Dell Vostro E5440</h3>
                                    <em>Category: <a href="linh-kien-dell.jsp">Dell</a></em>
                                </section>
                                <section class="right">
            ...
            <footer>
                <div class="content-wrap">
                    <div class="one-fourth first">
                        <h4>Thông tin</h4>
                        <ul>
                            <li><a href="ban-do.jsp">Về chúng tôi</a></li>
                    ...
                    <div class="one-fourth">
                        <h4>Tài khoản</h4>
                        <ul>
                            <li><a href="index.jsp">Tài khoản của tôi</a></li>
