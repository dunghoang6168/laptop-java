    	...
    	<header>
            ...
            <div id="top2">
            	<ul class="myaccountmenu">
                	<li><a href="account.jsp" class="first">Quản lý tài khoản</a></li>
                ...
                <a href="#" class="close"><img src="images/process-stop.png" class="btn_close" title="Close Window" alt="Close" /></a>
                  <form method="post" class="signin" action="#">
                        ...
                        <p>
                        <a class="forgot" href="#">Quên mật khẩu?</a> / <a class="register" href="register.jsp">Tạo Tài Khoản</a>
                        </p>        
                        </fieldset>
                  </form>
       			</div>
            ...
            <div id="top3">
            	<h1 class="logo"><a href="index-2.jsp">SSSSSSSSS</a></h1>
                <form action="#" method="post" class="search_bar">
                    <fieldset>
                      <input type="text" name="search" class="search" value="Nhập từ khóa..." />
        ...
        <div id="container">
        	<nav>  
                <ul id="mega-menu-3" class="mega-menu">
                    ...
                    <li><a href="clothing.jsp">Laptop Rẻ</a>
                        <ul>
                ...
                <li><a href="pan-mem.jsp">Phần mềm</a>
                	<ul>
                    	<li>
                        <ul class="menu-1">
                    ...
                    <div class="prod-detail">
                      <h2>Dell Latitude E5440- Core i7 4200U 3.2Ghz</h2>
                        <span class="price">7.800.000 VNĐ</span>
                         ...
                         <span class="cart-button"><a href="#">Thêm vào giỏ</a><a href="#">So sánh</a></span>
                         <div id="tab">
                            <ul class="nav">
                                <li class="nav-one"><a href="#details" class="current">Chi tiết</a></li>
                                <li class="nav-two"><a href="#specs">Cấu hình</a></li>
                                <li class="nav-three"><a href="#reviews">Tải Driver</a></li>
                                
                            </ul>
                            <div class="list-wrap">
                                <div id="details">
                                  <p>Dell Vostro V3560 - Vỏ nhôm i7
                                    ...
                                    HDD: 532GB (500GB HDD + 32GB SSD) có ssd cho tốc độ khởi động siêu nhanh
                                    ...
                                    Đèn bàn phím, Webcam, Lan, USB 3.0, DVD RW, HDMI... đầy đủ tính nẵng

                                    Máy chạy WINDOWS 7 64BIT bản quyền (Còn nguyên bản quyền theo máy)

                                    Máy nguyên rin từ A-Z mới 99% chưa khui tem.

                                    Máy phù hợp cho dân đồ họa, thiết kế đa phương tiện.

                                    - Bảo hành 3 tháng,

                                    - Bao dùng máy 1 tuần.

                                    - Đầy đủ phụ kiện rin kèm máy khi bán </p>
                                    
                                </div>
                                <ul id="specs" class="hide">
                                    <li><span>Mã Sản Phẩm:</span> LT 01</li>
                                    <li><span>Trạng thái hàng:</span> Vẫn còn 2 sp trong kho</li>
                                    <li><span>Giá:</span> 7.800.000 VNĐ</li>
