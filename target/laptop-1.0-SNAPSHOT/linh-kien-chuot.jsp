                        ...
                        <ul id="products" class="list clearfix">
                        	<li class="da-thumbs item">
                            	<div class="product-thumb-hover">
                                    <section class="left">
                                        <img src="images/linhkien/chuot-3.jpg" alt="">
                                        <p class="sale">Sale</p>
                            ...
                            <li class="da-thumbs item">
                            	<div class="product-thumb-hover">
                                    <section class="left">
                                        <img src="images/linhkien/chuot-1.jpg" alt="">
                                        <p class="new">New</p>
                                        <article class="da-animate da-slideFromRight" style="display: block;">
                                            <h3>Shoes</h3>
                                            <p>
                            ...
                            <li class="da-thumbs item">
                            	<div class="product-thumb-hover">
                                    <section class="left">
                                        <img src="images/linhkien/chuot-2.jpg" alt="">
                                        <p class="new">New</p>
                                        <article class="da-animate da-slideFromRight" style="display: block;">
                                            <h3>Shoes</h3>
                                            <p>
                            ...
                            <li class="da-thumbs item">
                            	<div class="product-thumb-hover">
                                    <section class="left">
                                        <img src="images/linhkien/chuot-4.jpg" alt="">
                                        <article class="da-animate da-slideFromRight" style="display: block;">
                                            <h3>Shoes</h3>
                                            <p>
                                            <a href="product-detail.jsp" class="link tip" title="View Detail"></a>&nbsp;
